...
public class DB_connection {
    ...
    private static void setConnection() throws Exception {
        ...
        c = DriverManager.getConnection("jdbc:mysql://localhost:3308/agrinova", "root", "");
    }
    ...
    public static int iudReturnId(String sql) throws Exception { //iud = insert,update,delete
        if (c == null) {
            setConnection();
        }
        int id = 0;
